...
Therefore I want to make sure that there is seamless cooperation with your company/event/organization.
...
- [2020](./public-workshops_2020.md)
- [2019](./public-workshops_2019.md)
- [2018](./public-workshops_2018.md)
- [2017](./public-workshops_2017.md)
...
In case you are interested in talks and presentations, here are some recent references:
...
trainer, developer, and consultant in frontend development with a focus on Angular, RxJS, Typescript and Ionic.
...
as well as the founder and leading head of [Angular Austria](www.angular-austria.at), a non-profit association to support Angular.
...
I know that it’s hard to organize events and have everything planned and in mind. In general, I try to gain my own view and opinion about people and events.
...
* :x: The event should have at least minimal support for the community.
     As a community enthusiast and active contributor, I welcome the support of the community and will actively share the event wherever I'm active.
...
- [x] In general, I rarely use videos or audios in my slides but for some GIF animations. If this is the case I will send these files also front off for a treat.
...
- [ ] **If possible, I'd like you to cover my travel expenses and hotel.** I don't expect first class or business class flights, but I do expect to arrive a day before the event and leave the day after with lodging organized in between.
...
- [ ] **I do expect to be paid for my workshops and training. This is what I make my living of.**
If you book me for a workshop and we did not agree on something else I expect to be paid for my workshop.

There are always options to haggle about these things. I'm a reasonable person and if you spend your time creating a great event where the money isn't your main goal, we'll find a way.
